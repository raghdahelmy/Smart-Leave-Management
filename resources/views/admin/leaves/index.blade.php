        ...
        <div class="card-body py-2">
            <form class="row g-2 align-items-end" method="GET">
                ...
                <div class="col-md-2 d-flex gap-1 align-self-end">
                    ...
                    <a href="{{ route('admin.leaves.index') }}" class="btn btn-sm btn-light">Reset</a>
                </div>
            </form>
        </div>
    </div>
                ...
                <tbody>
                    @forelse($leaves as $leave)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.leaves.show', $leave) }}" class="btn btn-sm btn-outline-primary"><i class="bi bi-eye"></i></a>
                            </td>
                        </tr>
                    @empty
